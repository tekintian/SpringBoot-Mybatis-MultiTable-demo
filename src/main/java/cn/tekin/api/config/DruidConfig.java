...
public class DruidConfig {
    ...
    final String DB_PREFIX="spring.datasource";
    /**
    ...
    public FilterRegistrationBean webStatFilter() {
        ...
        //指定排除监控
        filters.put("exclusions", "*.js,*.gif,*.jpg,*.png,*.css,*.ico,/druid/*");
        bean.setInitParameters(filters);
        //Arrays.asList("/") 将数组转换为集合
        bean.setUrlPatterns(Arrays.asList("/"));

        //另外一种方法 使用 addXXX方法
        //        FilterRegistrationBean bean2 = new FilterRegistrationBean(new WebStatFilter());
        //        bean2.addUrlPatterns("/*");
        //        bean2.addInitParameter("exclusions", "*.js,*.gif,*.jpg,*.png,*.css,*.ico,/druid/*");
